    ...
    public static class Commands
    {
        public static async void ListAllBooks()
        {
            using (var db = new AppDbContext())
            {
                ...
                {
                    Console.WriteLine($"Book: {book.title} by {book.BookAuthors} with ISBN {book.ISBN10}");
                }
            }
        }
        ...
        public static void AddBookAuthor()
        {
            using (var db = new AppDbContext())
            {
                ...
                var book = db.Books.Single(b => b.ISBN10.Equals(isbnInput));
        ...
        public static void AddReview()
        {
            using (var db = new AppDbContext())
            {
                ...
                var bookReviewed = db.Books.Single(b => b.ISBN10.Equals(isbnInput));
